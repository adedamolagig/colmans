@extends('layouts.master')
    ...
    @section('body')
        ...
        <div class="" style="padding-top: 45px; padding-bottom: 0px"></div>
          <div class="container col-md-8 col-md-offset-2" style="padding-top: 15px; padding-bottom: 15px; background: white">	
